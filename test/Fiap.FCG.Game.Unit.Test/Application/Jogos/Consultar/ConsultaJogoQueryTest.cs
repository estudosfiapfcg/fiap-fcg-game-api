...
using Fiap.FCG.Game.Unit.Test.Application.Jogos.Consultar.Fakers;
using Fiap.FCG.Game.Unit.Test.Application.Jogos.Consultar.Fixtures;
using FluentAssertions;
using Xunit;

namespace Fiap.FCG.Game.Unit.Test.Application.Jogos.Consultar;
